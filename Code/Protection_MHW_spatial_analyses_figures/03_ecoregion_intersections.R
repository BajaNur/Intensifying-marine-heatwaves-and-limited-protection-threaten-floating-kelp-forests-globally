...
# Load data --------------------------------------------------------------------
kelp <- st_read("Data/Processed/clean_kelp.gpkg")

mpas <- st_read("Data/Processed/clean_mpas.gpkg")

meow <- st_read("Data/Spalding Ecoregions/meow_ecos.shp")  ##Donwload at: https://databasin.org/datasets/3b6b12e7bcca419990c9081c0af254a2/
...
saveRDS(kelp_mpa_and_ecoregion,
        file = ("Data/Outputs/Protection Status/intersected_kelp_mpa_ecoregion.rds"))

st_write(obj = kelp_mpa_and_ecoregion,
         dsn = ("Data/Outputs/Protection Status/intersected_kelp_mpa_ecoregion.gpkg"),
         delete_dsn = T)
